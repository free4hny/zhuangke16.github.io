						...
						<svg ref="svg" width={2500} height={1000}>
							<defs>
								<linearGradient id="orange_red" x1="0%" y1="0%" x2="100%" y2="0%">
									<stop offset="0%" style={{"stop-color":"#FFAEC9",stop_opacity:"1"}}/>
									<stop offset="100%" style={{"stop-color":"#ED1C24", "stop-opacity":"1"}}/>
										//<stop offset="0%" style={{"stop-color":"#f9f9f9",stop_opacity:"1"}}/> 要改 白
									//<stop offset="100%" style={{"stop-color":"#2d004b", "stop-opacity":"1"}}/> 要改 深紫
									//<stop offset="0%" style={{"stop-color":"#fff7f3",stop_opacity:"1"}}/> 要改
									//<stop offset="100%" style={{"stop-color":"#49006a", "stop-opacity":"1"}}/> 要改
								</linearGradient>
								<linearGradient id="orange_red2" x1="0%" y1="0%" x2="100%" y2="0%">
									<stop offset="0%" style={{"stop-color":"#99D9EA",stop_opacity:"1"}}/>
									<stop offset="100%" style={{"stop-color":"#00A2E8", "stop-opacity":"1"}}/>
									//<stop offset="0%" style={{"stop-color":"#f9f9f9",stop_opacity:"1"}}/> 要改 白
									//<stop offset="100%" style={{"stop-color":"#7f3b08", "stop-opacity":"1"}}/> 要改 深土黄
									//<stop offset="0%" style={{"stop-color":"#fff7fb",stop_opacity:"1"}}/> 要改
									//<stop offset="100%" style={{"stop-color":"#014636", "stop-opacity":"1"}}/> 要改
								</linearGradient>
							</defs>
							<g id="map"/>
